  ...
  return (
    <div className="">
      <main className="flex flex-col gap-8  p-8 pb-20 gap-16 sm:p-20 md:px-48 ">
        ...
        <p className="text-justify leading-relaxed">We&apos;re excited to announce Oasis, the first realtime AI open-world model. It&apos;s a video game, but entirely generated by AI. Oasis is the first step in our research towards more complex interactive worlds. We&apos;re releasing the code, weights and a live playable demo.</p>
        ...
        <p className="text-justify leading-relaxed">We can capture a complete universe with consistent physical laws in the weights of a transformer and all we need is scale. Fast transformer inference unlocks video as an interface. Real-time is not coming, it&apos;s already here. </p>
        ...
        <div className="relative w-screen left-1/2 right-1/2 -mx-[50vw] my-4">
          <Carousel className="w-full">
            <CarouselContent>
              {[
                {src: "/5.webp", caption: "Exploring vast procedural landscapes"},
                {src: "/4.webp", caption: "Dynamic day/night cycles"},
                {src: "/1.webp", caption: "Real-time block manipulation"},
