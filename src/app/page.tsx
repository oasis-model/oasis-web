  ...
  return (
    <div className="">
      ...
      <main className="flex flex-col gap-8 p-8 pb-20 gap-16 sm:p-20 md:px-48">
        ...
        <p className="text-justify leading-relaxed">However, to make the model an additional order of magnitude faster, and make it cost-efficient to run at scale, new hardware is needed. Oasis is optimized for Sohu, the Transformer ASIC built by Etched. On NVIDIA H100s today, the model can run at 720p at 20fps. Sohu can run the same architecture as it scales up to 100B parameters at up to 4K resolution in FP16. </p>

        {/* <section className="flex justify-center items-center my-4">
        <Image src="/future.png" alt="Performance" width={500} height={500} />
        </section> */}
